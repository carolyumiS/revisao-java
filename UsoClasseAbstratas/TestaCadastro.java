...
public class TestaCadastro {
    public static void main(String[] args) {
        ...
        cadastro.cadastraPessoa(new Cliente("João", new Data(1, 1, 2000), 101));
        cadastro.cadastraPessoa(new Funcionario("Maria", new Data(2, 2, 1990), 3000));
        cadastro.cadastraPessoa(new Gerente("Carlos", new Data(3, 3, 1980), 5000, "TI"));
